...
[Documentation](https://github.com/foundationsedge/nv-i18n/blob/master/README.md).
...
- Open an [Issue](https://github.com/foundationsedge/nv-i18n/issues/new). (Since we can't be sure at this point
...
- Make sure that you are using the latest version.
- Read the [documentation](https://github.com/foundationsedge/nv-i18n/blob/master/README.md) carefully and find out if
...
* Once we are happy it works
  ...
  * Change:
    ...
    * Update [release notes](https://github.com/foundationsedge/nv-i18n/blob/master/CHANGELOG.md) to include changes
    in `1.1000.0`
    * Submit a PR

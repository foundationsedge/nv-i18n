...
nv-i18n Maintainers have write access to the [project GitHub repository](./MAINTAINERS.md).
They can merge patches from others. The current maintainers
...
and invited to the private maintainer mailing list (which we will then need to create!)

...
Several documents were copied from templates from [CNCF](https://github.com/cncf/project-template/)

Please also review [SustainOSS's Governance Readiness Checklist](https://sustainers.github.io/governance-readiness/)
as preparation for making governance decisions.

## Governance Template

[Governance maintainer](https://github.com/foundationsedge/nv-i18n/GOVERNANCE-maintainer.md) supplies rules for a simple self-selecting council
